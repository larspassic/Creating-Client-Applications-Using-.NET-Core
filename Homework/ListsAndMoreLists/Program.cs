...
namespace ListsAndMoreLists
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Removing users for their password matching their name: {passwordresults}");

            //Actually remove the users that we found
            users.Remove(passwordresults);
            ...
            //Explain to the console what we are going to do
            Console.WriteLine($"Removing the first user who's password is \"hello\": {helloresults}");
